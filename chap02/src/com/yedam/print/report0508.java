...
public class report0508 {
	public static void main(String[] args) {
		...
		/* 문제2) 문제 1번의 변수를 이용하여 각 연산을 수행한 결과를 출력하라.
		   ...
		   2.3) 91 곱하기 37
		   2.4) 91 나누기 37 */
		int sVar = iVar2 + iVar1;
		System.out.println(sVar);
		int mVar = iVar2 - iVar1;
		System.out.println(mVar);
		int pVar = iVar2 * iVar1;
		System.out.println(pVar);
		int dVar = iVar2 / iVar1;
		...
		*/
		...
		System.out.printf("%d", intValue1+intValue2);
		System.out.printf("%d", intValue3);
		System.out.printf("%s", strValue);
		System.out.printf("%4.1f\n", (float)intValue4);
		System.out.printf("%s%d%d%s%4.1f", charValue, (intValue1+intValue2), intValue3, strValue, (float)intValue4);
	}
}
